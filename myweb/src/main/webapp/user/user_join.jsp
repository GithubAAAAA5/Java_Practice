...
<body>
    ...
    <!-- footer 영역 -->
  	...
  	<script type="text/javascript">
  		function check() {
  			// form 은 유일하게 document.태그 이름으로 접근이 가능하다.
  			if (document.regform.id.value == '') {
  				...
  				alert("비밀번호와 비밀번호확인란에는 동일한 비밀번호를 입력해주세요.");
  				return;
  				...
  				// confirm() 확인창을 띄워서 확인 취소 둘중 하나 선택하는 메서드. 확인은 true 취소는 false
  				document.regform.submit();	//자바스크립트의 submit기능
  			}
